<template>
  <div class="w-full">
    ...
    <SharedFilesView class="py-2" role="admin" :subarchives="data.results.subarchives" @deleted="refresh" :current-directory="shared_directory._id" empty-message="No se han compartido archivos con tu usuario" />
  </div>
</template>
<script setup>
